...
class MathsQpDashboard extends StatelessWidget {
  const MathsQpDashboard({super.key});
                  ...
                  child: GridView.count(
                    ...
                    children: [
                      _buildCard(context, 'Class 9', Icons.format_list_numbered_outlined, onPressed: () {
                        ...
                        Navigator.of(context).push(MaterialPageRoute(builder: (context)=> const QuestionPaperMaths10()));
                      }),
